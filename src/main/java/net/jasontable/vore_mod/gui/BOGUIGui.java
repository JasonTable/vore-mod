...
public class BOGUIGui extends VoreModModElements.ModElement {
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		public void render(int mouseX, int mouseY, float partialTicks) {
			...
			bellyname.render(mouseX, mouseY, partialTicks);
			exitCMD.render(mouseX, mouseY, partialTicks);
		}
		...
		protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
			this.font.drawString("Belly Data", 5, 6, -16777216);
			this.font.drawString("Belly name: " + (new Object() {
			...
			this.font.drawString("Belly exit command: " + (new Object() {
				public String getValue(BlockPos pos, String tag) {
					TileEntity tileEntity = world.getTileEntity(pos);
					if (tileEntity != null)
						return tileEntity.getTileData().getString(tag);
		...
		public void init(Minecraft minecraft, int width, int height) {
			...
			bellyname = new TextFieldWidget(this.font, this.guiLeft + 5, this.guiTop + 28, 234, 20, "Belly name") {
				{
			...
			exitCMD = new TextFieldWidget(this.font, this.guiLeft + 5, this.guiTop + 61, 234, 20, "Exit Command") {
				{
			...
			this.addButton(new Button(this.guiLeft + 5, this.guiTop + 83, 81, 20, "Change values", e -> {
				VoreModMod.PACKET_HANDLER.sendToServer(new ButtonPressedMessage(0, x, y, z));

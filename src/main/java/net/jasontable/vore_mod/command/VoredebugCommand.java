...
public class VoredebugCommand extends VoreModModElements.ModElement {
	public VoredebugCommand(VoreModModElements instance) {
		super(instance, 30);
	}
	...
	private LiteralArgumentBuilder<CommandSource> customCommand() {
		return LiteralArgumentBuilder.<CommandSource>literal("voredebug").requires(s -> s.hasPermissionLevel(3))

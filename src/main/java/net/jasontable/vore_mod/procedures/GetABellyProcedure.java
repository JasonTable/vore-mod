...
public class GetABellyProcedure extends VoreModModElements.ModElement {
	public GetABellyProcedure(VoreModModElements instance) {
		super(instance, 39);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				System.err.println("Failed to load dependency entity for procedure GetABelly!");
			return;
		}

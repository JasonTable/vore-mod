...
public class TongueBlock extends VoreModModElements.ModElement {
	@ObjectHolder("vore_mod:tongue")
	public static final Block block = null;
	public TongueBlock(VoreModModElements instance) {
		super(instance, 4);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.EARTH).sound(SoundType.SLIME).hardnessAndResistance(1f, 6f).lightValue(0));
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.SOUTH));
			setRegistryName("tongue");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(FleshItem.block, (int) (5)));
		}

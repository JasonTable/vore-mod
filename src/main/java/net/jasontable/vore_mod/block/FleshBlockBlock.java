...
public class FleshBlockBlock extends VoreModModElements.ModElement {
	@ObjectHolder("vore_mod:fleshblock")
	public static final Block block = null;
	public FleshBlockBlock(VoreModModElements instance) {
		super(instance, 1);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(FleshItem.block, (int) (3)));
		}

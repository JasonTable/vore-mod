...
public class AcidBlock extends VoreModModElements.ModElement {
	@ObjectHolder("vore_mod:acid")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("vore_mod:acid_bucket")
	public static final Item bucket = null;
	public static FlowingFluid flowing = null;
	public static FlowingFluid still = null;
	private ForgeFlowingFluid.Properties fluidproperties = null;
	public AcidBlock(VoreModModElements instance) {
		super(instance, 15);
	...
	public void initElements() {
		fluidproperties = new ForgeFlowingFluid.Properties(() -> still, () -> flowing,
				FluidAttributes.builder(new ResourceLocation("vore_mod:blocks/assid"), new ResourceLocation("vore_mod:blocks/assid")).luminosity(0)
